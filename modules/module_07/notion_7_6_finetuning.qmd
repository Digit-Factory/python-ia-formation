...
# Sauvegarde en JSONL
with open("/tmp/dataset_techvolt.jsonl", "w") as f:
    for ex in dataset_techvolt:
        f.write(json.dumps(ex, ensure_ascii=False) + "\n")

# Relire pour vérifier
with open("/tmp/dataset_techvolt.jsonl") as f:
    for ligne in f:
        ex = json.loads(ligne)
...
ds = Dataset.from_json("/tmp/dataset_techvolt.jsonl")
...
# Sauvegarde
with open("/tmp/avis_techvolt.jsonl", "w") as f:
