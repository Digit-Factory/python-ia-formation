...
f_train = torchvision.datasets.FashionMNIST(
    root="/tmp/fmnist", train=True, download=True, transform=transform_fmnist
)
f_test = torchvision.datasets.FashionMNIST(
    root="/tmp/fmnist", train=False, download=True, transform=transform_fmnist
)
...
train_aug = torchvision.datasets.MNIST(
    root="/tmp/mnist", train=True, download=True, transform=transform_augment
)
...
f_train_aug = torchvision.datasets.FashionMNIST(
    root="/tmp/fmnist", train=True, download=True, transform=transform_fmnist_aug
)
f_test_t = torchvision.datasets.FashionMNIST(
    root="/tmp/fmnist", train=False, download=True, transform=transform_fmnist_test
)
